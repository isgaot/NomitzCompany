...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("NomitzCompany");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("NomitzCompany");
        ...
        config.getMapConfigs().put("it.itzware.nomitz.company.domain.*", initializeDomainMapConfig(jHipsterProperties));
